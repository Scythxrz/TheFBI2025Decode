...
public class Poses {
    ...
    public static final Pose GOAL_BLUE = new Pose(10,   134.5, 0);
    ...
    public static final Pose CLOSE_PGP   = new Pose(13,   65);
    public static final Pose CLOSE_PGP_1 = new Pose(35.292, 55.076);
    public static final Pose CLOSE_GATE = new Pose(8.5, 62.8, rad(160));
